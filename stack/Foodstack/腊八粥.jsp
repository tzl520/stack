				...
				<div class="row">
					<div class="col-xl-8 col-lg-8 mb-30">
						<div class="news-wrapper single-news">
							<div class="news-img">
								<img src="img/news/blog/腊八粥.jpg"  height="700px" width="732px"/>
							</div>
							<div class="news-text">
								<span>北京小吃</span>
								<h3>腊八粥</h3>
								<p>腊八粥有糯米、芝麻、苡仁、桂元、红枣、香菇、莲子等八种食物。  在白米等精细食材的基础上，适当搭配一些糙米类、杂粮类等谷物，这样粗细搭配不仅吃起来更有质感，而且可以摄取更丰富的营养物质。
								</p>
								<blockquote class="blockquote">
									<p>最超值的地方: </p>
							   </blockquote>
							   <p>和胃、补脾、养心、清肺、益肾、利肝、明目、安神、通便。</p>
						   </div>
					...
					<div class="col-xl-3 col-lg-3 mb-30">
						...
						<div class="widget mb-55">
							...
							<ul class="blog-menu">
								<li><a href="">圆糯米150克</a></li>
								<li><a href="">绿豆25克</a></li>
								<li><a href="">红豆25克</a></li>
								<li><a href="">腰果25克</a></li>
								<li><a href="">花生25克</a></li>
								<li><a href="">桂圆25克</a></li>
								<li><a href="">莲子100克</a></li>
								<li><a href="">栗子100克</a></li>
								<li><a href="">冰糖75克</a></li>
								<li><a href="">精盐10克</a></li>
