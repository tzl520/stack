				...
				<div class="row">
					<div class="col-xl-8 col-lg-8 mb-30">
						<div class="news-wrapper single-news">
							<div class="news-img">
								<img src="img/news/blog/油焖大虾.jpg"  height="700px" width="732px"/>
							</div>
							<div class="news-text">
								<span>山东小吃</span>
								<h3>油焖大虾</h3>
								<p>油焖大虾使用的主料是螯虾。传统的油焖大虾比潜江的“五七油焖大虾”更偏重于健康和养身，经过几年的沉淀，在营养健康和口味口感上达到极致，即保持了原料虾的营养最小的流失水平，又在口味口感上适应众口难调的食客。
								</p>
								<blockquote class="blockquote">
									<p>最超值的地方: </p>
							   </blockquote>
							   <p> 色泽浅红油亮，口味鲜香醇厚，鲜咸微甜。</p>
					...
					<div class="col-xl-3 col-lg-3 mb-30">
						...
						<div class="widget mb-55">
							...
							<ul class="blog-menu">
								<li><a href="">对虾8只</a></li>
								<li><a href="">花生油100克</a></li>
								<li><a href="">香油25克</a></li>
								<li><a href="">料酒25克</a></li>
								<li><a href="">味精5克</a></li>
								<li><a href="">白糖30克</a></li>
								<li><a href="">姜片50克</a></li>
								<li><a href="">葱花</a></li>
								<li><a href="">陈醋</a></li>
								<li><a href="">花椒</a></li>
