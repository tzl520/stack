				...
				<div class="row">
					<div class="col-xl-8 col-lg-8 mb-30">
						<div class="news-wrapper single-news">
							<div class="news-img">
								<img src="img/news/blog/松糕.jpg"  height="700px" width="732px"/>
							</div>
							<div class="news-text">
								<span>浙江小吃</span>
								<h3>松糕</h3>
								<p>温州松糕又以矮人松糕最为闻名。这矮人松糕实际上就是猪油糯米白糖糕，它所选用的全是这一年的纯糯米，过水磨成细粉，拌以猪臀尖肥肉丁、桂花和白糖，再炊熟切块。
								现做现卖的矮人松糕，吃起来松软绵糯，甜中有咸，点缀于上面的桂花更是让它清香无比。
								</p>
					...
					<div class="col-xl-3 col-lg-3 mb-30">
						...
						<div class="widget mb-55">
							...
							<ul class="blog-menu">
								<li><a href="">粳米100克</a></li>
								<li><a href="">浊酒20克</a></li>
								<li><a href="">黑芝麻25克</a></li>
								<li><a href="">大枣</a></li>
								<li><a href="">花生碎</a></li>
								<li><a href="">白糖</a></li>
								<li><a href="">纯净水</a></li>
