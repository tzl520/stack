				...
				<div class="row">
					<div class="col-xl-8 col-lg-8 mb-30">
						<div class="news-wrapper single-news">
							<div class="news-img">
								<img src="img/news/blog/八宝菜.jpg"  height="700px" width="732px"/>
							</div>
							<div class="news-text">
								<span>浙江小吃</span>
								<h3>八宝菜</h3>
								<p>此菜在皖江地区有几百年的历史，顾名思义、代代相传，家喻户晓，每年春节的前两天每家必备的一道小菜，营养丰富、方便食用、便于保存。用于调味，具有清口解腻、增进食欲的功效；
								其中的有机酸及其盐被人体消化后能生成碱性的矿物质，可调节人体内的酸碱平衡，防止血液的酸性偏高。
								</p>
