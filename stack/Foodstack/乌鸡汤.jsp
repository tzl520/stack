				...
				<div class="row">
					<div class="col-xl-8 col-lg-8 mb-30">
						<div class="news-wrapper single-news">
							<div class="news-img">
								<img src="img/news/blog/乌鸡汤.jpg"  height="700px" width="732px"/>
							</div>
							<div class="news-text">
								<span>云南小吃</span>
								<h3>乌鸡汤</h3>
								<p>乌鸡汤是广东省传统的地方名菜，以乌鸡、阿胶、黄精、桂圆、红枣、枸杞等食材制作而成。乌鸡营养丰富，并含有激素和紫色素，对人体白血球和血色素有增强的作用。
					...
					<div class="col-xl-3 col-lg-3 mb-30">
						...
						<div class="widget mb-55">
							...
							<ul class="blog-menu">
								<li><a href="">乌骨鸡500克</a></li>
								<li><a href="">陈皮3克</a></li>
								<li><a href="">高良姜3克</a></li>
								<li><a href="">草果5克</a></li>
								<li><a href="">大葱10克</a></li>							
								<li><a href="">胡椒6克</a></li>
								<li><a href="">醋5克</a></li>
