				...
				<div class="row">
					<div class="col-xl-8 col-lg-8 mb-30">
						<div class="news-wrapper single-news">
							<div class="news-img">
								<img src="img/news/blog/金华火腿.jpg"  height="700px" width="732px"/>
							</div>
							<div class="news-text">
								<span>浙江小吃</span>
								<h3>金华火腿</h3>
								<p>金华火腿内含丰富的蛋白质和脂肪，多种维生素和矿物质；制作经冬历夏，经过发酵分解，营养成分更易被人体所吸收，具有养胃生津、益肾壮阳、固骨髓、健足力、愈创口等作用。
								其外形皮薄爪细，皮色黄亮、形似琵琶、肉色红润、香气浓郁，以色、香、味、形“四绝”闻名于世。
								</p>
								<blockquote class="blockquote">
									<p>最超值的地方: </p>
							   </blockquote>
							   <p>色泽鲜艳，红白分明，瘦肉香咸带甜，肥肉香而不腻，美味可口。</p>
					...
					<div class="col-xl-3 col-lg-3 mb-30">
						...
						<div class="widget mb-55">
							...
							<ul class="blog-menu">
								<li><a href="">金华火腿</a></li>
								<li><a href="">香油6克</a></li>
								<li><a href="">芝麻油5克</a></li>
								<li><a href="">山茶油3克</a></li>
								<li><a href="">海盐2克</a></li>
								<li><a href="">鲜辣椒</a></li>
								<li><a href="">生姜</a></li>
								<li><a href="">蒜蓉</a></li>
