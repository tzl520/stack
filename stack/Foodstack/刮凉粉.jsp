				...
				<div class="row">
					<div class="col-xl-8 col-lg-8 mb-30">
						<div class="news-wrapper single-news">
							<div class="news-img">
								<img src="img/news/blog/刮凉粉.jpg"  height="700px" width="732px"/>
							</div>
							<div class="news-text">
								<span>湖南小吃</span>
								<h3>刮凉粉</h3>
								<p>“长沙街头有很多诱人的小吃，臭豆腐、糖油粑粑、葱油粑粑、口味虾、唆螺等等等等，而夏天，最受欢迎的莫过于刮凉粉了，只要你冲着摊主喊一声“来碗刮凉粉！”摊主便会麻利地拿出模具，
								很快便刮出一条条细长白嫩而且光滑的凉粉来，装进碗里后配上红红的辣椒油、翠绿的葱花和香喷喷的花生碎，那就是夏日里最大的满足了。” </p>
								<blockquote class="blockquote">
									<p>最超值的地方: </p>
							   </blockquote>
							   <p>口味酸辣，清凉爽滑，为夏季风味食品。</p>
						   </div>
                            ...
                            <div class="sidebar-rc-post">
                                <ul>
                                    <li>
                                        <div class="rc-post-thumb">
                                            <a href="blog-details.jsp">
                                                <img src="img/news/blog-left/老北京疙瘩汤.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="rc-post-content">
                                            <h4>
                                                <a href="blog-details.jsp">老北京疙瘩汤</a>
                                            </h4>
                                            <div class="widget-date">北京小吃</div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="rc-post-thumb">
                                            <a href="blog-details.jsp">
                                                <img src="img/news/blog-left/门丁肉饼.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="rc-post-content">
                                            <h4>
                                                <a href="blog-details.jsp">门丁肉饼</a>
                                            </h4>
                                            <div class="widget-date">北京小吃</div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="rc-post-thumb">
                                            <a href="blog-details.jsp">
                                                <img src="img/news/blog-left/老北京驴打滚.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="rc-post-content">
                                            <h4>
                                                <a href="blog-details.jsp">老北京驴打滚</a>
                                            </h4>
                                            <div class="widget-date">北京小吃</div>
                                        </div>
                                    </li>
