				...
				<div class="row">
					<div class="col-xl-8 col-lg-8 mb-30">
						<div class="news-wrapper single-news">
							<div class="news-img">
								<img src="img/news/blog/朝鲜冷面.jpg"  height="700px" width="732px"/>
							</div>
							<div class="news-text">
								<span>吉林小吃</span>
								<h3>朝鲜冷面</h3>
								<p>正宗的朝鲜水冷面一般在夏天食用。朝鲜冷面多用碗食用，亦有用碟子盛装的，但冷面的汤就相对较少了。冷面的作法，是把面条煮熟后，用凉水抄干后的面条，再放进盐、醋、酱油等调味料，
								并再加番茄、黄瓜等青菜作伴菜。吃时把伴菜与面条拌好，再配以朝鲜咸菜或泡菜，即可食用。
								</p>
					...
					<div class="col-xl-3 col-lg-3 mb-30">
						...
						<div class="widget mb-55">
							...
							<ul class="blog-menu">
								<li><a href="">荞面400克</a></li>
								<li><a href="">淀粉600克 </a></li>
								<li><a href="">牛肉</a></li>
								<li><a href="">香油</a></li>
								<li><a href="">时蔬</a></li>
								<li><a href="">酱油</a></li>
