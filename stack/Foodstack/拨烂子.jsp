				...
				<div class="row">
					<div class="col-xl-8 col-lg-8 mb-30">
						<div class="news-wrapper single-news">
							<div class="news-img">
								<img src="http://s1.st.meishij.net/r/80/133/5970830/a5970830_151304522033590.jpg"  height="600px" width="732px"/>
							</div>
							<div class="news-text">
								<span>广西菜</span>
								<h3>拨烂子</h3>
								<p>不烂子（本名拌子）也称拨烂子，是一种山西省、河北省南部部分城市传统面食。不烂子将蔬菜（如土豆、茄子、豆角等）拌入面粉或棒子面，搅拌均匀后上笼蒸熟。春末榆树槐树开花时也可以用榆钱、槐花做食材。另外，白菜叶子也可以用来做不烂子，但是不需要蒸煮，直接翻炒即可。
</p>
								<blockquote class="blockquote">
									<p>最超值的地方: </p>
							   </blockquote>
							   <p>1.好吃。2.解馋。 3.不烂子富含淀粉，营养价位很丰富，能够提供人体所需的能量。4.淀粉与蔬菜的结合，不仅能够丰富口感，而且蔬菜能补充人体所需的维生素。						
                           </p>
					...
					<div class="col-xl-3 col-lg-3 mb-30">
						...
						<div class="widget mb-55">
							...
							<ul class="blog-menu">
								<li><a href="">面粉（300克）</a></li>
								<li><a href="">槐花（300克）</a></li>
								<li><a href="">食用油（50克）</a></li>							
								<li><a href="">鸡蛋（2个）</a></li>							
								<li><a href="">盐（3克</a></li>
