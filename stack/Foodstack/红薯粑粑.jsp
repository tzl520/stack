				...
				<div class="row">
					<div class="col-xl-8 col-lg-8 mb-30">
						<div class="news-wrapper single-news">
							<div class="news-img">
								<img src="img/news/blog/红薯粑粑.jpg"  height="700px" width="732px"/>
							</div>
							<div class="news-text">
								<span>湖南小吃</span>
								<h3>红薯粑粑</h3>
								<p>红薯含有维生素C、维生素B、维生素A等8种维生素和磷、铁等10多种矿物元素，还含有大量的功效奇特，红薯纤维素含量高，这类物质可增加粪便体积，促进肠胃蠕动，清理肠腔内滞留的粘液、积气和腐败物，
								排出粪便中的有毒物质和致癌物质，保持大便畅通，改善消化道环境，防止胃肠道疾病的发生。紫薯中锌、铁、铜、锰、钙、硒均为天然，并且铁、钙含量特高。非常适合给小朋友食用。 </p>
								<blockquote class="blockquote">
									<p>最超值的地方: </p>
							   </blockquote>
							   <p>口感香甜软糯、有益于心脏、预防肺气肿、抗癌作用、有利减肥、有利于健美。</p>
						   </div>
                            ...
                            <div class="sidebar-rc-post">
                                <ul>
                                    <li>
                                        <div class="rc-post-thumb">
                                            <a href="blog-details.jsp">
                                                <img src="img/news/blog-left/广东烧麦.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="rc-post-content">
                                            <h4>
                                                <a href="blog-details.jsp">广东烧麦</a>
                                            </h4>
                                            <div class="widget-date">广东小吃</div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="rc-post-thumb">
                                            <a href="blog-details.jsp">
                                                <img src="img/news/blog-left/乳香葱油饼.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="rc-post-content">
                                            <h4>
                                                <a href="blog-details.jsp">乳香油葱饼 </a>
                                            </h4>
                                            <div class="widget-date">广东小吃</div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="rc-post-thumb">
                                            <a href="blog-details.jsp">
                                                <img src="img/news/blog-left/广东椰蓉紫薯南瓜球.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="rc-post-content">
                                            <h4>
                                                <a href="blog-details.jsp">广东椰蓉紫薯南瓜球</a>
                                            </h4>
                                            <div class="widget-date">广东小吃</div>
                                        </div>
                                    </li>
