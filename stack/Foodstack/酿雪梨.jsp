				...
				<div class="row">
					<div class="col-xl-8 col-lg-8 mb-30">
						<div class="news-wrapper single-news">
							<div class="news-img">
								<img src="img/news/blog/酿雪梨.jpg"  height="700px" width="732px"/>
							</div>
							<div class="news-text">
								<span>云南小吃</span>
								<h3>酿雪梨</h3>
								<p>酿雪梨，是白族人民的传统甜菜，所属菜系:云贵菜-滇菜。
					...
					<div class="col-xl-3 col-lg-3 mb-30">
						...
						<div class="widget mb-55">
							...
							<ul class="blog-menu">
								<li><a href="">雪梨1500克</a></li>
								<li><a href="">冰糖100克</a></li>
								<li><a href="">糯米50克</a></li>
								<li><a href="">莲子80克</a></li>
								<li><a href="">松子仁 50克</a></li>							
								<li><a href="">柿饼60克</a></li>
								<li><a href="">熟猪油1000克</a></li>
								<li><a href="">火腿:80克</a></li>
