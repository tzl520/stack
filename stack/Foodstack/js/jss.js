    ...
    Calendar.prototype = {
        ...
        getTemplate1: function () {
            ...
            return '<div class="atie-calendar" tabindex="0">' +
                ...
                '<a class="atie-calendar-prev-year-btn" role="button"><<</a>' +
                '<a class="atie-calendar-prev-month-btn" role="button"><</a>' +
                ...
                '</span>' +
                '<a class="atie-calendar-next-month-btn">></a>' +
                '<a class="atie-calendar-next-year-btn">>></a>' +
                '</div>' +
                '</div>' +
