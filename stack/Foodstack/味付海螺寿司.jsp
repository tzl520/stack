			...
			<div class="row">
				<div class="col-xl-8 col-lg-8 mb-30">
					<div class="news-wrapper single-news">
						<div class="news-img">
							<img
								src="http://pic.51yuansu.com/pic3/cover/01/62/24/5955f14e9609c_610.jpg"
						...
						<div class="news-text">
							...
							<p>1.
将米饭煮熟，打散，散热2.
装起两饭碗大米饭，加入3茶匙的寿司醋，搅拌均匀3.
模具放入一片紫菜，然后装入米饭，压紧4.
切成小段5.
取3块紫菜饭图摆到寿司碟上6.
海螺肉切成碎粒7.
用汤勺将海螺肉勺到紫菜饭团上，然后准备好芥末酱油即可开动</p>
							<blockquote class="blockquote">
								<p>最超值的地方:</p>
							</blockquote>
							<p>“上次聚会给家人做了很多种类的寿司，这次清明假期，表弟要求我给他补做一些，上次他没有吃上。所以我把家里剩下的食材拿出来，给他做了两大盒统一口味的海螺寿司，嘻嘻，让他一次性吃饱！”</p>
						</div>
