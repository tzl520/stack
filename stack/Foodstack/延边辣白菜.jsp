				...
				<div class="row">
					<div class="col-xl-8 col-lg-8 mb-30">
						<div class="news-wrapper single-news">
							<div class="news-img">
								<img src="img/news/blog/延边辣白菜.jpg"  height="700px" width="732px"/>
							</div>
							<div class="news-text">
								<span>吉林小吃</span>
								<h3>延边辣白菜</h3>
								<p>延边朝鲜族辣白菜的腌制与四川泡菜的最大区别在于调味酱的使用。延边辣白菜后发酵之前，把调味酱均匀地涂抹在“初腌制”的白菜每片叶子表面，在低温乳酸发酵。
								调味酱由辅料、香辛料、调味料组成。辅料又由蔬菜类、水果类、坚果类、淀粉类和动物类原料组成。
								</p>
