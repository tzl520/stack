				...
				<div class="row">
					<div class="col-xl-8 col-lg-8 mb-30">
						<div class="news-wrapper single-news">
							<div class="news-img">
								<img src="img/news/blog-left/灯影牛肉干.jpg"  height="700px" width="732px"/>
							</div>
							<div class="news-text">
								<span>重庆小吃</span>
								<h3>灯影牛肉干</h3>
								<p>灯影牛肉干产于四川达县地区的南江、通江、平昌、巴中等县，至今已有近100年的历史。灯影牛肉干片薄似纸，可透灯影，故此得名。
								</p>
								<blockquote class="blockquote">
									<p>最超值的地方: </p>
							   </blockquote>
							   <p>青少年食谱 运动员食谱 健脾开胃食谱 营养不良食谱 </p>
						   </div>
