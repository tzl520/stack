...
<header>
		...
		</header><div class="bottom_back_top_top bottom_back_top_top_slideUp" id="bottom_back_top_top"><a href="#" class="backtotop pngFix">回到顶部</a></div><div class="main_w clearfix"><div class="main clearfix">
	...
	<ul class="user_inner_tab_ul"><li><a href="showMyself.jsp" class="link">编辑个人资料</a></li><li><a href="photo.jsp" class="link">修改头像</a></li><li><a href="password.jsp" class="current link">修改密码</a></li></ul>
</div>	<div class="sixin_list">
		<div class="sixin_list_w">
			<div class="useredit_w">
								<ul class="useredit_ul clearfix">
				<form method="POST" action="${pageContext.request.contextPath }/HomeUser?method=updatePwd">
				<input type="hidden" value="${sessionScope.user.id }" name="id">
					<li><dl class="clearfix"><dt>旧密码：</dt><dd class="dd1"><input type="text" value="${sessionScope.user.loginPwd }" name="oldpassword" style="height: 30px" class="text"></dd><dd class="dd2"></dd></dl></li>
					<li><dl class="clearfix"><dt>新密码：</dt><dd class="dd1"><input type="password" id="pwd" name="password" style="height: 30px" class="text"></dd><dd class="dd2"></dd></dl></li>
					<li><dl class="clearfix"><dt>重复密码：</dt><dd class="dd1"><input type="password" id= "pwds" name="re_password" style="height: 30px" class="text"></dd><dd class="dd2 dds" style="color:red;"></dd></dl></li>
