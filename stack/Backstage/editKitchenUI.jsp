      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li class="active"><a href="${pageContext.request.contextPath}/Kitchen?method=show">厨房百科维护</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <a href="javascript:;">
        ...
        <section class="wrapper site-min-height">
            <div class="row mt">
                <div class="col-lg-8 col-lg-offset-2 detailed mt">
                    ...
                    <form role="form" class="form-horizontal" method="post" action="${pageContext.request.contextPath }/Kitchen?method=editKitchen&pageNo=${pageNo}" enctype="multipart/form-data">
                     <div class="form-group">
                            <div class="col-lg-6">
                                <input type="hidden" value = "${ke.id }" id="id" class="form-control" name = "id">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <c:set  var="names" value="${names}" scope="request"/>
                            	<select name = "fatherName"class="form-control" id="sele">
                            		<c:forEach items="${kitList }" var="kit">
                            			<option value="${kit.fatherName }" <c:if test="${kit.fatherName==names }">selected</c:if> >${kit.fatherName }</option>
                            		</c:forEach>
                            	</select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" value="${ke.name }"name = "name" id="name" class="form-control">
                            </div>
                        </div>
                        <br>
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <img id= "img" name ="img" src="${ke.img }">
                                <input type="file" name = "img" value="${ke.img }" style="display: none"/>
                            </div>
                        </div>
                        <br>
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                 <textarea rows="4" cols="30" name = "title">${ke.title }</textarea>
                            </div>
                        </div>
                        <br>
                        <div class="form-group">
                            <div class="col-lg-offset-2 col-lg-10">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <a href="${pageContext.request.contextPath }/Kitchen?method=kitchenUI&pageNo=${pageNo}"><button class="btn btn-theme04" type="button">退出</button></a>
                            </div>
                        </div>
                    </form>
                </div>
