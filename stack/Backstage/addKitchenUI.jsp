        ...
        <section class="wrapper site-min-height">
            <div class="row mt">
                <div class="col-lg-8 col-lg-offset-2 detailed mt">
                    <h4 class="mb">新增菜品</h4>
                    <form role="form" class="form-horizontal" method="post" action="${pageContext.request.contextPath }/Kitchen?method=add&pageNo=${pageNo}" enctype="multipart/form-data">
                        <div class="form-group">
                            <label class="col-lg-2 control-label">菜系</label>
                            <div class="col-lg-6">
                                <select class="form-control" name = "fatherName">
                                		<option value = ""> </option>
                                    <c:forEach items="${kList }" var="k">
                                    	<option value="${k.fatherName }">${k.fatherName }</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
