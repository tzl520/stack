        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li class="active"><a href="${pageContext.request.contextPath}/ForeignMenu?method=menuUI">外国菜谱管理</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <a href="javascript:;">
        ...
        <section class="wrapper site-min-height">
            <div class="row mt">
                <div class="col-lg-8 col-lg-offset-2 detailed mt">
                    <h3 class="mb">小吃信息修改</h3>
                    <form role="form" class="form-horizontal" method="post" action="${pageContext.request.contextPath }/ForeignMenu?method=editmenu&pageNo=${pageNo}" enctype="multipart/form-data">
                     <div class="form-group">
                            <div class="col-lg-6">
                                <input type="hidden" value = "${menu.id }" id="id" class="form-control" name = "id">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-2 control-label">小吃地名</label>
                            <div class="col-lg-6">
                            <c:set  var="names" value="${names}" scope="request"/>
                            	<select name = "fatherName"class="form-control" id="sele">
                            		<c:forEach items="${menus }" var="mus">
                            			<option value="${mus.fatherName }" <c:if test="${mus.fatherName==names }">selected</c:if> >${mus.fatherName }</option>
                            		</c:forEach>
                            	</select>
                            </div>
                        </div>
                        <br>
                        <div class="form-group">
                            <label class="col-lg-2 control-label">小吃</label>
                            <div class="col-lg-6">
                                <input type="text" value="${menu.name }"name = "name" id="name" class="form-control">
                            </div>
                        </div>
                        <br>
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <img id= "img" name ="img" src="${menu.img }">
                                <input type="file" name = "img" value="${menu.img }" style="display: none"/>
                            </div>
                        </div>
                        <br>
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <textarea rows="4" cols="30" name = "title">${menu.title }</textarea>
                            </div>
                        </div>
                        <br>
                        <div class="form-group">
                            <div class="col-lg-offset-2 col-lg-10">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <a href="${pageContext.request.contextPath }/ForeignMenu?method=menuUI&pageNo=${pageNo}"><button class="btn btn-theme04" type="button">退出</button></a>
                            </div>
                        </div>
                    </form>
                </div>
