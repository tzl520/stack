        ...
        <section class="wrapper site-min-height">
            <div class="row mt">
                <div class="col-lg-8 col-lg-offset-2 detailed mt">
                    <h3 class="mb">用戶信息修改</h3>
                    <form role="form" class="form-horizontal" method="post" action="${pageContext.request.contextPath }/User?method=editUser&pageNo=${pageNo}" enctype="multipart/form-data">
                     <div class="form-group">
                            <div class="col-lg-6">
                                <input type="hidden" value = "${user.id }" id="id" class="form-control" name = "id">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <img id= "img" name ="img" src="${user.img }">
                                <input type="file" name = "img" value="${user.img }" style="display: none"/>
                            </div>
                        </div>
                        <br>
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" value="${user.loginName }" id="title" name = "loginName" class="form-control">
                            </div>
                        </div>
                        <br>
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" value="${user.name }" id="title" name = "name" class="form-control">
                            </div>
                        </div>
                        <br>
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" value="${user.email }" id="title" name = "email" class="form-control">
                            </div>
                        </div>
                        <br>
                         <div class="form-group">
                            <label class="col-lg-2 control-label">用户性别</label>
                            <div class="col-lg-6">
                               	<p>
                               		男&nbsp;&nbsp;<input type="radio" value="1"<c:if test="${user.sex==1 }">checked</c:if> name = "sex">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                	女&nbsp;&nbsp;<input type="radio" value="0"<c:if test="${user.sex==0 }">checked</c:if> name = "sex">
                               	</p>
                            </div>
                        </div>
                        <br>
                        <div class="form-group">
                            <label class="col-lg-2 control-label">用户电话</label>
                            <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            <div class="col-lg-offset-2 col-lg-10">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <a href="${pageContext.request.contextPath }/User?method=show&pageNo=${pageNo}"><button class="btn btn-theme04" type="button">退出</button></a>
                            </div>
                        </div>
                    </form>
                </div>
