...
<%@ include file="../header/admin_header.jsp" %>
    ...
    <section id="main-content" style="height: 650px;">
      <section class="wrapper">
          ...
          <div class="col-md-12 mt">
            <div class="content-panel">
              <table class="table table-hover">
                <h4><i class="fa fa-angle-right"></i>厨房信息</h4>
                <hr>
                <thead>
                <tr>
                  <th>编号</th>
                ...
                <tbody>
               		<c:forEach items="${kList }" var="kit">
               			<tr>
                		<td>${kList.id }</td>
			                <td>${kList.fatherName }</td>
			                <td>${kList.name }</td>
			                <td><img src="${kList.img }"></td>
			                <td>${kList.title }</td>
			                <td>
	                    		<a href="${pageContext.request.contextPath }/Kitchen?method=editKitchenUI&id=${kList.id}&pageNo=${pageNo}"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button></a>
	                    		<a href="${pageContext.request.contextPath }/Kitchen?method=deleteKitchen&id=${kList.id}&pageNo=${pageNo}"><button class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></button></a>
	                 		</td>
                		</tr>
               		</c:forEach>
                </tbody>
        ...
        <a href="${pageContext.request.contextPath }/Kitchen?method=addKitchenUI&pageNo=${pageNo}" style="display:inline-block;margin-top: 20px;">
