...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="index.html" class="logo"><b>STA<span>CK</span></b></a>
      <!--logo end-->
      <div class="top-menu">
        <ul class="nav pull-right top-menu">
          <li><a class="logout" href="(登录)login.html">Logout</a></li>
        </ul>
      </div>
    </header>
    <!--header end-->
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href="(数据)Data.html"><img src="img/ui-sam.jpg" class="img-circle" width="80"></a></p>
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a href="(各地小吃)snacksEverywhere.html">各地小吃</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <a href="javascript:;">
            ...
            <ul class="sub">
              <li><a href="(中国菜谱)ChineseMenu.html">中国菜谱管理</a></li>
              <li><a href="(外国菜谱)ForeignMenu.html">外国菜谱管理</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <a href="javascript:;">
            ...
            <ul class="sub">
              <li><a href="(周边摆盘)WobblePlate.html">Blank Page</a></li>
              <li><a href="(登录)login.html">Login</a></li>
              <li><a href="lock_screen.html">Lock Screen</a></li>
              <li><a href="(数据)Data.html">Profile</a></li>
              <li><a href="(烹饪技巧)CookingSkills.html">Invoice</a></li>
              <li><a href="(厨房妙招)KitchenTrick.html">Pricing Table</a></li>
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a href="(用户信息维护)InformationMaintenance.html">Form Components</a></li>
              <li><a href="advanced_form_components.html">Advanced Components</a></li>
              <li><a href="form_validation.html">Form Validation</a></li>
              <li><a href="(用户审核)UserAudit.html">Contact Form</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <a href="javascript:;">
            ...
            <ul class="sub">
              <li><a href="(首页推荐)HomeRecommendation.html">Basic Table</a></li>
              <li><a href="(首页热搜)HotSearchHome.html">Responsive Table</a></li>
