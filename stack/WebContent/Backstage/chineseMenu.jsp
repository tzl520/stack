...
<%@ include file="../header/admin_header.jsp" %>
    ...
    <section id="main-content" style="height: 650px;">
      <section class="wrapper">
          ...
          <div class="col-md-12 mt">
            <div class="content-panel">
              <table class="table table-hover">
                <h4><i class="fa fa-angle-right"></i>中国菜谱信息</h4>
                <hr>
                <thead>
                <tr>
                  <th>编号</th>
                ...
                <c:forEach items="${menu }" var="m">
                	<tr>
		                ...
		                <td>${m.title }</td>
		                <td>
                    		<a href="${pageContext.request.contextPath }/ChineseMenu?method=editmenuUI&id=${m.id}&pageNo=${pageNo}"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button></a>
                    		<a href="${pageContext.request.contextPath }/ChineseMenu?method=deletemenu&id=${m.id}&pageNo=${pageNo}"><button class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></button></a>
                 		</td>
                </tr>
                </c:forEach>
                </tbody>
        ...
        <a href="${pageContext.request.contextPath }/ChineseMenu?method=addmenuUI&pageNo=${pageCount}" style="display:inline-block;margin-top: 20px;">
  ...
  <!--script for this page-->
	 <script type="text/javascript">
	  function gotopage(num){
		 　window.location.href = "${pageContext.request.contextPath}/ChineseMenu?method=menuUI&pageNo="+num;
		}
  </script>
</body>
