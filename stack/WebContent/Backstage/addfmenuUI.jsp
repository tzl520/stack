        ...
        <section class="wrapper site-min-height">
            <div class="row mt">
                <div class="col-lg-8 col-lg-offset-2 detailed mt">
                    <h4 class="mb">新增菜品</h4>
                    <form role="form" class="form-horizontal" method="post" action="${pageContext.request.contextPath }/ForeignMenu?method=add&pageNo=${pageNo}" enctype="multipart/form-data">
