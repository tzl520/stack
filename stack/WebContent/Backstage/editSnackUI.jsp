        ...
        <section class="wrapper site-min-height">
            <div class="row mt">
                <div class="col-lg-8 col-lg-offset-2 detailed mt">
                    ...
                    <form role="form" class="form-horizontal" method="post" action="${pageContext.request.contextPath }/Snack?method=editSnack&pageNo=${pageNo}" enctype="multipart/form-data">
                     <div class="form-group">
                            <div class="col-lg-6">
                                <input type="hidden" value = "${sanck.id }" id="id" class="form-control" name = "id">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <c:set  var="names" value="${names}" scope="request"/>
                            	<select name = "fatherName"class="form-control" id="sele">
                            		<c:forEach items="${snacks }" var="sn">
                            			<option value="${sn.fatherName }" <c:if test="${sn.fatherName==names }">selected</c:if> >${sn.fatherName }</option>
                            		</c:forEach>
                            	</select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" value="${sanck.name }"name = "name" id="name" class="form-control">
                            </div>
                        </div>
                        <br>
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <img id= "img" name ="img" src="${sanck.img }">
                                <input type="file" name = "img" value="${sanck.img }" style="display: none"/>
                            </div>
                        </div>
                        <br>
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                            	<textarea rows="4" cols="30" name = "title">${sanck.title }</textarea>
                            </div>
                        </div>
                        <br>
                        <div class="form-group">
                            <div class="col-lg-offset-2 col-lg-10">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <a href="${pageContext.request.contextPath }/Snack?method=snackUI&pageNo=${pageNo}"><button class="btn btn-theme04" type="button">退出</button></a>
                            </div>
                        </div>
                    </form>
                </div>
