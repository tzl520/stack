				...
				<div class="row">
					<div class="col-xl-8 col-lg-8 mb-30">
						<div class="news-wrapper single-news">
							<div class="news-img">
								<img src="img/news/blog/牛犊汤.jpg"  height="700px" width="732px"/>
							</div>
							<div class="news-text">
								<span>辽宁小吃</span>
								<h3>牛犊汤</h3>
								<p>在辽宁西部，多民族杂居，饮食也多受影响，牛犊子汤受到人们的普遍欢迎。将和成的荞面赶成薄片，切成小方块，在开水中煮熟捞出，与和好的芝麻糊搅匀即可；
								或者将荞面搓成疙瘩，再捻成猫耳朵形的面片（也有的用擀切的白面片儿），用牛奶煮熟后，佐以黄油、奶皮子、白糖食用。
								</p>
