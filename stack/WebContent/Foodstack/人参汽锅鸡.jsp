				...
				<div class="row">
					<div class="col-xl-8 col-lg-8 mb-30">
						<div class="news-wrapper single-news">
							<div class="news-img">
								<img src="img/news/blog/人参汽锅鸡.jpg"  height="700px" width="732px"/>
							</div>
							<div class="news-text">
								<span>吉林小吃</span>
								<h3>人参汽锅鸡</h3>
								<p>“汽锅鸡”是云南特有名菜，历史悠久，素负盛名。它是用云南建水陶制汽锅蒸鸡而得名。此菜可用于大小宴会，也可用于食疗滋补，还可用于家庭便餐。
							   ...
							   <p>此汤原汁原味，鲜香味美，而且有极佳的养生美容之功效，是食疗的上品之选。</p>
