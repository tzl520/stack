				...
				<div class="row">
					<div class="col-xl-8 col-lg-8 mb-30">
						<div class="news-wrapper single-news">
							<div class="news-img">
								<img src="img/news/blog/白皮酥.jpg"  height="700px" width="732px"/>
							</div>
							<div class="news-text">
								<span>辽宁小吃</span>
								<h3>白皮酥</h3>
								<p>白皮酥是特色传统糕点之一，外皮为水面油酥，内有馅心。其特点为：皮酥馅香，入口酥软，层次分明，色泽洁白，花样繁多。
								特别之处在于外层的白皮，先以水油面皮包裹油酥面团，收紧揉园之后再度擀开，反复擀至均匀才作为最终的外层白皮，制作工艺严谨考究。
								</p>
								<blockquote class="blockquote">
									<p>最超值的地方: </p>
							   </blockquote>
							   <p>雪白色，馅甜香，呈圆鼓形，皮酥松。</p>
						   </div>
