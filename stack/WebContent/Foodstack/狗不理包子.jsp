				...
				<div class="row">
					<div class="col-xl-8 col-lg-8 mb-30">
						<div class="news-wrapper single-news">
							<div class="news-img">
								<img src="img/news/blog/狗不理包子.jpg"  height="700px" width="732px"/>
							</div>
							<div class="news-text">
								<span>天津小吃</span>
								<h3>狗不理包子</h3>
								<p>狗不理包子采用“半发面，水打馅”制作工艺。皮子薄而带韧劲；馅以精肉斩得细而匀，加姜、酱油、香油、味精、排骨汤等。做出的包子要求不走形，不掉底，不漏油，个个呈菊花形状。
					...
					<div class="col-xl-3 col-lg-3 mb-30">
						...
						<div class="widget mb-55">
							...
							<ul class="blog-menu">
								<li><a href="">面粉750克</a></li>
								<li><a href="">净猪肉500克</a></li>
								<li><a href="">生姜5克</a></li>
								<li><a href="">酱油125克</a></li>
								<li><a href="">水422毫升</a></li>
								<li><a href="">香油60克</a></li>
								<li><a href="">碱适量</a></li>
