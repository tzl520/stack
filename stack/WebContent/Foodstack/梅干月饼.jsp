				...
				<div class="row">
					<div class="col-xl-8 col-lg-8 mb-30">
						<div class="news-wrapper single-news">
							<div class="news-img">
								<img src="img/news/blog/梅干月饼.jpg"  height="700px" width="732px"/>
							</div>
							<div class="news-text">
								<span>安徽小吃</span>
								<h3>梅干月饼</h3>
								<p>梅干月饼的饼馅一般分为软硬两种，软馅中含水分较多，只能保存7到10天左右，而硬馅梅干月饼则可保存1个月左右。盒装梅干月饼，应将盒盖打开，使其通风；
								另外，因梅干月饼中含脂肪较多，存放时还应注意避光，以防油脂氧化。
								</p>
								<blockquote class="blockquote">
									<p>最超值的地方: </p>
							   </blockquote>
							   <p>其味清香，酥软可口，甜而不腻，营养丰富。</p>
						   </div>
					...
					<div class="col-xl-3 col-lg-3 mb-30">
						...
						<div class="widget mb-55">
							...
							<ul class="blog-menu">
								<li><a href="">全麦面粉100克</a></li>
								<li><a href="">花生油25克</a></li>
								<li><a href="">奶粉5克</a></li>
								<li><a href="">苦板材300克</a></li>
								<li><a href="">蛋黄</a></li>
								<li><a href="">糖浆75克</a></li>
								<li><a href="">纯净水</a></li>
