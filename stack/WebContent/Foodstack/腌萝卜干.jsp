				...
				<div class="row">
					<div class="col-xl-8 col-lg-8 mb-30">
						<div class="news-wrapper single-news">
							<div class="news-img">
								<img src="img/news/blog/湖南腌萝卜干.jpg"  height="700px" width="732px"/>
							</div>
							<div class="news-text">
								<span>湖南小吃</span>
								<h3>腌萝卜干</h3>
								<p>腌萝卜干是用萝卜制作的一道家常菜。萝卜干制作一般是在冬至前后进行，要经过“晒、腌、藏”三道工序。腌萝卜干具有鲜、香、甜等独特风味，
								其呈香物质多由蛋白质的分解而形成，萝卜内的蛋白质在腌制过程中、在后熟期受微生物作用及蛋白质自身水解酶的作用而逐渐分解为各种氨基酸，从而产生鲜香及甜味。
 </p>
								<blockquote class="blockquote">
									<p>最超值的地方: </p>
							   </blockquote>
							   <p>腌萝卜干具有鲜、香、甜等独特风味。</p>
						   </div>
                            ...
                            <div class="sidebar-rc-post">
                                <ul>
                                    <li>
                                        <div class="rc-post-thumb">
                                            <a href="blog-details.jsp">
                                                <img src="img/news/blog-left/烤羊肉串.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="rc-post-content">
                                            <h4>
                                                <a href="blog-details.jsp">烤羊肉串</a>
                                            </h4>
                                            <div class="widget-date">新疆小吃</div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="rc-post-thumb">
                                            <a href="blog-details.jsp">
                                                <img src="img/news/blog-left/新疆凉面.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="rc-post-content">
                                            <h4>
                                                <a href="blog-details.jsp">新疆凉面 </a>
                                            </h4>
                                            <div class="widget-date">新疆小吃</div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="rc-post-thumb">
                                            <a href="blog-details.jsp">
                                                <img src="img/news/blog-left/熏马肠.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="rc-post-content">
                                            <h4>
                                                <a href="blog-details.jsp">熏马肠</a>
                                            </h4>
                                            <div class="widget-date">新疆小吃</div>
                                        </div>
                                    </li>
