				...
				<div class="row">
					<div class="col-xl-8 col-lg-8 mb-30">
						<div class="news-wrapper single-news">
							<div class="news-img">
								<img src="img/news/blog/温州鸭舌.jpg"  height="700px" width="732px"/>
							</div>
							<div class="news-text">
								<span>浙江小吃</span>
								<h3>温州鸭舌</h3>
								<p>温州是一个水城，有瓯江，紧邻大海。水城是有鸭子的，大规模养鸭以后，温州的副食加工业崛起，有名牌“鲜八里”，分解了鸭子，鸭舌成了一道名菜。它是一道凉菜，鸭舌是卤的，风至半干，在口中细嚼，韧性十足，颇为耐嚼。
								</p>
					...
					<div class="col-xl-3 col-lg-3 mb-30">
						...
						<div class="widget mb-55">
							...
							<ul class="blog-menu">
								<li><a href="">鸭舌200克</a></li>
								<li><a href="">麻油15毫升</a></li>
								<li><a href="">大豆油12毫升</a></li>
								<li><a href="">老抽</a></li>
								<li><a href="">生抽</a></li>
								<li><a href="">面粉</a></li>
								<li><a href="">味精</a></li>
								<li><a href="">料酒</a></li>
								<li><a href="">生姜，蒜蓉</a></li>
