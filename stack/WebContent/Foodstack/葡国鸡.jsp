				...
				<div class="row">
					<div class="col-xl-8 col-lg-8 mb-30">
						<div class="news-wrapper single-news">
							<div class="news-img">
								<img src="http://s1.ig.meishij.net/p/20111221/240d2fc8c272fa32b37577fbbac488c3_150x150.jpg"  height="600px" width="732px"/>
							</div>
							<div class="news-text">
								<span>港台菜</span>
								<h3>葡国鸡</h3>
								<p>葡国鸡算是澳门的代表菜之一。是葡国人从非洲及印度食品中学到的将整鸡、土豆、洋葱、鸡蛋，配以咖喱盐制而成的美食。其特点为香味浓郁、鸡肉鲜嫩可口。
</p>
					...
					<div class="col-xl-3 col-lg-3 mb-30">
						...
						<div class="widget mb-55">
							...
							<ul class="blog-menu">
								...
								<li><a href="">土豆2个</a></li>
								<li><a href="">鸡蛋1个</a></li>							
								<li><a href="">黄洋葱1个</a></li>							
								<li><a href="">椰奶2汤匙</a></li>
								<li><a href="">鲜奶4汤匙</a></li>		
								<li><a href="">咖喱粉1汤匙</a></li>
								<li><a href="">植物油</a></li>							
