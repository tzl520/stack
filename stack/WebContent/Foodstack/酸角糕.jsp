				...
				<div class="row">
					<div class="col-xl-8 col-lg-8 mb-30">
						<div class="news-wrapper single-news">
							<div class="news-img">
								<img src="img/news/blog/酸角糕.jpg"  height="700px" width="732px"/>
							</div>
							<div class="news-text">
								<span>云南小吃</span>
								<h3>酸角糕</h3>
								<p>酸角糕，云南特产。酸角糕精选云南热带雨林珍果——酸角为主要原料，酸角糕果味纯正、口感津润、老少皆宜，满足了现代人追求食品健康化、营养化的特点，老幼四季皆宜，被人们称为“可以嚼着吃的果汁”。在云南比较常见的有酸角果派。
								</p>
								<blockquote class="blockquote">
									<p>最超值的地方: </p>
							   </blockquote>
							   <p>保持了酸角原果口味，酸甜爽口、回味无穷，真正的绿色健康、无任何添加剂、防腐剂和色素。</p>
						   </div>
