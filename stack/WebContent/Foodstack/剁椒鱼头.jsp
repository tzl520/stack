				...
				<div class="row">
					<div class="col-xl-8 col-lg-8 mb-30">
						<div class="news-wrapper single-news">
							<div class="news-img">
								<img src="img/news/blog/剁椒鱼头.jpg"  height="700px" width="732px"/>
							</div>
							<div class="news-text">
								<span>湖南小吃</span>
								<h3>剁椒鱼头</h3>
								<p>剁椒鱼头，以鱼头的“味鲜”和剁椒的“辣”为一体。火辣辣的红剁椒，覆盖着白嫩嫩的鱼头肉，冒着热腾腾清香四溢的香气。蒸制的方法，鱼头的鲜香被尽量保留在肉质之内，
								剁椒的味道又恰到好处地渗入到鱼肉当中，入口细嫩晶莹，带着一股温文尔雅的辣味。
								</p>

								<blockquote class="blockquote">
									<p>最超值的地方: </p>
							   </blockquote>
							   <p>菜品色泽红亮、味浓、肉质细嫩。肥而不腻、口感软糯、鲜辣适口。
							 </p>
						   </div>
					...
					<div class="col-xl-3 col-lg-3 mb-30">
						...
						<div class="widget mb-55">
							...
							<ul class="blog-menu">
								<li><a href="">鲢鱼头1000克</a></li>
								<li><a href="">食盐3克</a></li>
								<li><a href="">植物油4汤匙</a></li>
								<li><a href="">蒸鱼豉油4汤匙</a></li>
								<li><a href="">剁椒3汤匙</a></li>
								<li><a href="">姜10克</a></li>
								<li><a href="">葱10克</a></li>																		
							</ul>
                        </div>
