				...
				<div class="row">
					<div class="col-xl-8 col-lg-8 mb-30">
						<div class="news-wrapper single-news">
							<div class="news-img">
								<img src="img/news/blog/长春酱肉.jpg"  height="700px" width="732px"/>
							</div>
							<div class="news-text">
								<span>吉林小吃</span>
								<h3>长春酱肉</h3>
								<p>酱肉是将猪肉用甜面酱、香辛调味料腌制后经自然风干而成的一类腌制类生肉制品，具有色泽美观、风味浓郁的特点，由于添加了甜面酱，故称为酱肉。
					...
					<div class="col-xl-3 col-lg-3 mb-30">
						...
						<div class="widget mb-55">
							...
							<ul class="blog-menu">
								<li><a href="">猪前五花肉1000克</a></li>
								<li><a href="">酱油200克</a></li>
								<li><a href="">熟火硝1克</a></li>
								<li><a href="">精盐20克</a></li>
								<li><a href="">料酒20克</a></li>
								<li><a href="">葱、姜、蒜各15克</a></li>
								<li><a href="">香料</a></li>
								<li><a href="">白糖15克</a></li>
							</ul>
                        </div>
                        <div class="widget mb-55">
