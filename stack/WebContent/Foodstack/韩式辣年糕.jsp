			...
			<div class="row">
				<div class="col-xl-8 col-lg-8 mb-30">
					<div class="news-wrapper single-news">
						<div class="news-img">
							<img
								src="http://pic.51yuansu.com/pic3/cover/01/83/34/596fd03821259_610.jpg"
								height="600px" width="732px" />
						</div>
						<div class="news-text">
							<span>韩国料理</span>
							<h3>韩式辣年糕</h3>
							<p>1. 准备好所有食材2. 炒锅烧热后，倒入芥花油，煸香葱沫3. 放入年糕4. 倒入适量清水5. 加盖大火6.
								煮开后，边搅拌边加入韩国辣椒酱7. 再倒入番茄酱8. 拌匀后倒入细砂糖9. 待酱汁炒至浓稠不多时，即可关火</p>
				...
				<div class="col-xl-3 col-lg-3 mb-30">
					...
					<div class="widget mb-55">
						...
						<ul class="blog-menu">
							<li><a href="">年糕</a></li>
							<li><a href="">韩式辣椒酱</a></li>
							<li><a href="">胡萝卜及西芹</a></li>
							<li><a href="">番茄酱</a></li>
							<li><a href="">清水</a></li>
							<li><a href="">豆腐</a></li>
						</ul>
