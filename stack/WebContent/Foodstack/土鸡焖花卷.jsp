				...
				<div class="row">
					<div class="col-xl-8 col-lg-8 mb-30">
						<div class="news-wrapper single-news">
							<div class="news-img">
								<img src="https://s1.st.meishij.net/r/140/225/5056390/a5056390_155894477911128.jpg"  height="600px" width="732px"/>
							</div>
							<div class="news-text">
								<span>清真菜</span>
								<h3>土鸡焖花卷</h3>
								<p>沙湾的土豆青椒炖土鸡配皮带面，最近新疆流行的小土鸡焖花卷有点改良的意思，很多内地的朋友可能还没有听过。 沙湾大盘鸡成形于90年，成熟于92年。96年在新疆达到鼎盛。传到内地是以后的事了。</p>
