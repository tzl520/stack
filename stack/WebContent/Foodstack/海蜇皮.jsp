				...
				<div class="row">
					<div class="col-xl-8 col-lg-8 mb-30">
						<div class="news-wrapper single-news">
							<div class="news-img">
								<img src="img/news/blog/海蜇皮.jpg"  height="700px" width="732px"/>
							</div>
							<div class="news-text">
								<span>辽宁小吃</span>
								<h3>海蜇皮</h3>
								<p>海蜇皮：海蛰含有人体需要的多种营养成分，尤其含有人们饮食中所缺的碘，是一种重要的营养食品。
								海蜇具有清热，化痰，消积，通便之功效，用于阴虚肺燥、高血压、痰热咳嗽、哮喘、瘰疬痰核、食积痞胀、大便燥结等症。
								</p>
								<blockquote class="blockquote">
									<p>最超值的地方: </p>
							   </blockquote>
							   <p>具有清热解毒调理，祛痰调理，便秘调理，消化不良调理等功效。</p>
						   </div>
					...
					<div class="col-xl-3 col-lg-3 mb-30">
						...
						<div class="widget mb-55">
							...
							<ul class="blog-menu">
								<li><a href="">海蜇皮300克</a></li>
								<li><a href="">黄瓜200克</a></li>
								<li><a href="">鸡胸脯肉25克</a></li>
								<li><a href="">火腿25克</a></li>
								<li><a href="">香油15克</a></li>
								<li><a href="">盐15克</a></li>
