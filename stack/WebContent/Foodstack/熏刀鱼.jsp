				...
				<div class="row">
					<div class="col-xl-8 col-lg-8 mb-30">
						<div class="news-wrapper single-news">
							<div class="news-img">
								<img src="https://s1.st.meishij.net/r/143/54/3701143/a3701143_154320275282841.jpg"  height="700px" width="732px"/>
							</div>
							<div class="news-text">
								<span>徽菜</span>
								<h3>熏刀鱼</h3>
								<p>食品的烟熏处理技术最早出于防腐的目的，常用于鱼类、肉制品的加工中，有着悠久的历史。随着冷藏技术的发展，防腐已不再成为烟熏技术的主要目的，它使产品具有轻淡的烟熏味而变得风味独特。烟熏制品的熏香味是多种化合物综合形成的，其中酚类化合物是使制品形成烟熏味的主要成分。
								</p>
								<blockquote class="blockquote">
									<p>最超值的地方: </p>
							   </blockquote>
							   <p>温中补虚，有利湿、暖胃和平肝、祛风等功效。</p>
					...
					<div class="col-xl-3 col-lg-3 mb-30">
						...
						<div class="widget mb-55">
							...
							<ul class="blog-menu">
								<li><a href="">鲳鱼 500g</a></li>
								<li><a href="">葱花 1大匙</a></li>
								<li><a href="">姜 3片</a></li>
								<li><a href="">油 适量</a></li>
								<li><a href="">酒 3大匙</a></li>
								<li><a href="">酱油 3大匙</a></li>
								<li><a href="">茴香1个</a></li>
								<li><a href="">五香粉1小匙</a></li>
								<li><a href="">糖1大匙</a></li>
