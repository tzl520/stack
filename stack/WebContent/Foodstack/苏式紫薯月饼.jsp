				...
				<div class="row">
					<div class="col-xl-8 col-lg-8 mb-30">
						<div class="news-wrapper single-news">
							<div class="news-img">
								<img src="http://s1.ig.meishij.net/p/20110831/ef64d73996e2a856f506e0856d8e7bea_150x150.jpg"  height="600px" width="732px"/>
							</div>
							<div class="news-text">
								<span>苏菜</span>
								<h3>苏氏紫薯月饼</h3>
								<p>紫薯月饼即以紫薯泥为主要材料制作的月饼。紫薯是当今公认的养生保健食物之一，紫薯中含有丰富的蛋白质，还有丰富的硒和铁，含有大量药用价值高的花青素，能减少抗生素给人体带来的危害。。</p>
					...
					<div class="col-xl-3 col-lg-3 mb-30">
						...
						<div class="widget mb-55">
							...
							<ul class="blog-menu">
								<li><a href="">紫薯1000克</a></li>
								<li><a href="">花生油70克</a></li>
								<li><a href="">砂糖95克</a></li>							
								<li><a href="">澄粉40克</a></li>							
								<li><a href="">转化糖浆150克</a></li>
								<li><a href="">枧水3克</a></li>							
								<li><a href="">低粉200克</a></li>															
