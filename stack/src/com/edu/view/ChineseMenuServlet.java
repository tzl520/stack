...
/**
 * Servlet implementation class ChineseMenuServlet
 */
public class ChineseMenuServlet extends HttpServlet {
	  ...
	  @Override
	    protected void service(HttpServletRequest req, HttpServletResponse resp) 
	       ...
	       private void add(HttpServletRequest req, HttpServletResponse resp) 
	   		...
	   		ChineseMenu menu = new ChineseMenu();
	   		// Parse the request
	   		try {
	   			...
	   			ChineseMenuService menuService = new ChineseMenuServiceImpl();
		...
		private void addmenuUI(HttpServletRequest req, HttpServletResponse resp) 
			...
			ChineseMenuService menuService = new ChineseMenuServiceImpl();
			try {
				List<ChineseMenu> menuList = menuService.getName();
				req.setAttribute("menuList", menuList);
				req.setAttribute("pageNo", pageNo);
				req.getRequestDispatcher("/Backstage/addmenuUI.jsp").forward(req, resp);
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
	       ...
	       private void editmenuUI(HttpServletRequest req, HttpServletResponse resp) 
	    	   ...
	    	   try {
	    		   ChineseMenuService menuService = new ChineseMenuServiceImpl();
	    		   ChineseMenu menu = menuService.getById(id);
	    		   List<ChineseMenu> muList = menuService.getFatherName();
		...
		private void menuUI(HttpServletRequest req, HttpServletResponse resp) 
			...
			try {
				...
				ChineseMenuService menuService = new ChineseMenuServiceImpl();
				List<ChineseMenu> menuList = menuService.getAll(pageNo);
...
//				resp.sendRedirect(req.getContextPath()+"/Backstage/snacksEveryWhere.jsp");
				req.getRequestDispatcher("/Backstage/chineseMenu.jsp").forward(req, resp);
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
